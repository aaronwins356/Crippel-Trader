...
```bash
git remote add encore encore://crypto-quant-bot-n6x2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/crypto-quant-bot-n6x2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/crypto-quant-bot-n6x2/settings/integrations/github)
